...
## In Progress
- **[congress-trading-shared][AG] Usage Monitor shared resources & publint dependency update (2026-07-23).** Adding Usage Monitor route constants, producer/provider enums, and event creation helper to `src/usageTelemetry.ts`; updating `publint` dependency; releasing `v2.2.0`. Branch `ag/usage-monitor-resources-and-dep-updates`.
